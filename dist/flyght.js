...
})({"aZoIU":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 44431;
var HMR_SECURE = false;
var HMR_ENV_HASH = "3d476702079ea291";
module.bundle.HMR_BUNDLE_ID = "a8ca3df860dcf643";
"use strict";
...
},{}],"1SRgo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = Flyght = class {
    #config = {};
    #defaultConfig = {};
    #element = null;
    constructor(config){
    ...
    register() {
        ...
        if ($links) $links.forEach(($el, key, $parent)=>{
            ...
            this.#config.urlConfiguration.push({
                hash: $el.hash || `#${$el.name || $el.href}`,
                url: $el.href,
                type: "GET"
            });
        });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"inbr1"}],"inbr1":[function(require,module,exports) {
...
},{}]},["aZoIU","1SRgo"], "1SRgo", "parcelRequiref9a0")
